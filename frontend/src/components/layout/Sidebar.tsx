  ...
  return (
    <aside className="flex h-screen w-60 shrink-0 flex-col border-r border-border bg-primary text-white">
      <div className="px-5 py-6">
        <p className="font-display text-lg font-semibold leading-tight">Arba Minch</p>
        <p className="text-xs uppercase tracking-wider text-white/60">Resource Management</p>
      </div>
